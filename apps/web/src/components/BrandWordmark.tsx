  ...
  return (
    <svg viewBox="0 0 220 100" className={className} role="img" aria-label="창문">
      ...
      <g stroke={ink} strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" fill="none">
        {/* 창: ㅊ — 평범한 고딕 글자꼴 기반. 점획만 살짝 기울여 한자(붓) 기운 (사용자 피드백) */}
        <line x1="34" y1="10" x2="46" y2="6" />
        <line x1="18" y1="21" x2="62" y2="21" />
        <line x1="40" y1="23" x2="21" y2="44" />
        <line x1="40" y1="23" x2="59" y2="44" />
        {/* 창: ㅇ — 받침은 글자 블록 중앙 축, ㅅ 다리에 바짝 */}
        <circle cx="46" cy="69" r="17" />
        {/* 창: ㅏ */}
