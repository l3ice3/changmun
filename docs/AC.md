...
| FR ID | 기능명 | 연결 AC | 상태 |
|---|---|---|---|
| FR-001 | 공고 수집 파이프라인 | AC-001 ~ AC-005 | 부분 구현 — K-Startup **라이브 검증 완료**(2026-06-11, 29,046건·재실행 신규0/갱신29,046·스킵0, AC-002~005 Pass) / bizinfo·ontong-youth 키 발급 대기 |
| FR-002 | dedup & 페르소나 부여 | AC-006 ~ AC-010 | 미구현 |
