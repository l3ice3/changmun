...
> 참고: 사용자 노출용 "용어 사전 기능"(`GET /api/v1/glossary`)과는 다른 것. 이건 개발 식별자 합의표다.
...
## 규칙
1. 클래스·메서드·변수·DB 컬럼·API 경로 모두 표준어를 쓴다. (예: `OpportunityController`, `/api/v1/opportunities`, `opportunityId`)
